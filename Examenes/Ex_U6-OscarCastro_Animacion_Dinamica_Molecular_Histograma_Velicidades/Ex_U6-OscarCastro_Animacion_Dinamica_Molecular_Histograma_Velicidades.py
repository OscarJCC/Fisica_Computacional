"""
Nombre: Ex_U6-OscarCastro_Animacion_Dinamica_Molecular_Histograma_Velicidades
Fecha Inicio:
Fecha Final:
...
def metodoVerlet(p,v,t0): # Funcion -> Metodo De Verlet
     a0 = cA(p)
...
def update(i):
     ...
     l2.clear()
     l2.set_title(f"Dinamica Molecular\nGas De Argon Diluido\nVelocidades", fontsize = 15)
     l2.set_xlabel(r"$Velocidades$")
     l2.set_ylabel(r"$Particulas$")
     l2.hist(vx,dn, color = "Purple", rwidth=0.85)
     plt.xticks(dn)
