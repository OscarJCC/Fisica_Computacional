...
fig, l1 = plt.subplots(facecolor = "blue")
...
def Descripcion():
     messagebox.showinfo("Descripción", "Este programa usa el método de Verlet para simular el en 2D, el movimiento de las partículas que interaccionan entre si del gas de Argón diluido, por medio del potencial de Lennard Jones.")
