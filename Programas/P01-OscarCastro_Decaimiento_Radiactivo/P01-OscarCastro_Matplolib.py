...
def Metodo_De_Euler(Nu0,t0,tf,T,h,N):
     vg = [Nu0] # Lista para guardan las interaciones de Nu(t)
...
Metodo_De_Euler(Nu0,t0,tf,T,h1,"Metodo de Euler \n Grafica 1, Tamaño de paso h = 1")
Metodo_De_Euler(Nu0,t0,tf,T,h2,"Metodo de Euler \n Grafica 2, Tamaño de paso h = 0.5")
Metodo_De_Euler(Nu0,t0,tf,T,h3,"Metodo de Euler \n Grafica 3, Tamaño de paso h = 0.1")
Metodo_De_Euler(Nu0,t0,tf,T,h4,"Metodo de Euler \n Grafica 4, Tamaño de paso h = 0.05")
Metodo_De_Euler(Nu0,t0,tf,T,h5,"Metodo de Euler \n Grafica 5, Tamaño de paso h = 0.01")
