"""
Nombre: P36-OscarCastro Dinamica Molecular 3
Fecha Inicio:
Fecha Final:
...
#fig, (l1,l2) = plt.subplots(facecolor = "blue")
...
l2.set_title(f"Temperatura", fontsize = 10)
l3.set_title(f"Temperatura Promedio", fontsize = 10)
...
def update(i):
     ...
     l2.set_title(f"Temperatura = {round(Tg,3)}", fontsize = 10)
     l2.set_ylabel(r"$Temperatura$")
     l2.axhline(color = "red")
     l2.axvline(color = "red")
     l2.plot(t0,Tg,".", color = "Purple")
     
     l3.set_title(f"Temperatura Promedio = {round(Tp/j,3)}", fontsize = 10)
     l3.set_xlabel(r"$Tiempo$")
     l3.set_ylabel(r"$Temperatura$")
     l3.axhline(color = "red")
     l3.axvline(color = "red")
     l3.plot(t0,Tp/j,".", color = "Purple")
