"""
Nombre: P06-OscarCastro Movimiento De Proyectiles Caso Ideal
Fecha Inicio:
Fecha Final:
...
def Grafica(xg,yg,vxg,vyg,vg,tg,N):
     ...
     l3.legend(edgecolor = "red", fontsize = 15, labelcolor = color)
     ...
     l2.legend(edgecolor = "red", fontsize = 15, labelcolor = color)
     ...
     l0.legend(edgecolor = "red", fontsize = 15, labelcolor = color)
